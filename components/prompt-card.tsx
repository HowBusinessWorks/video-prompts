...
export default function PromptCard({ prompt }: PromptCardProps) {
  ...
  return (
    <Card className="border-4 border-black rounded-xl overflow-hidden shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] cursor-pointer hover:translate-y-[-4px] transition-transform h-full flex flex-col">
